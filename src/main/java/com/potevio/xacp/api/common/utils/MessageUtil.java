...
/**
 * @program: spring-cloud-vue
 * @description: 阿里云短信服务
 * @author: Mr.lv
 * @create: 2018-08-04 16:16
 **/
public class MessageUtil {
    ...
    static final String accessKeyId = "LTAISt5yEKK5TbQG";
    static final String accessKeySecret = "oq9uRe3LcVf1x7CLpflbQlHECS08Hm";
