...
public class FastJsonUtils {
	 ...
	 * 生成json返回结果
	 */
	public static String resultSuccess(Object code,String msg,Object data){
		 Map<String,Object> rs= new HashMap<String,Object>();
		 rs.put("status", 1);
		 rs.put("code",code);
		 rs.put("message",StringUtils.isNotEmpty(msg)?msg:SUCCESS_MSG);
		 rs.put("data", data==null ? new Object() : data);
		 return toString(rs);
	}
	
	public static String resultError(Object code,String error,Object data){
		 Map<String,Object> rs= new HashMap<String,Object>();
		rs.put("status", 0);
		 rs.put("code",code);
		 rs.put("data", data==null ? new Object() : data);
		 rs.put("message",StringUtils.isNotEmpty(error)?error:"");
		 return toString(rs);
	}
	 ...
	 * 生成json返回结果
	 */
	public static String resultList(Object code,String msg,Integer pageNo,Integer pageSize,Object data){
		 Map<String,Object> rs= new HashMap<String,Object>();
		 rs.put("code",code);
	 ...
	 * 生成json返回结果
	 */
	public static String resultFeatures(Object code,String msg,Object data,SerializerFeature... feature){
		Map<String,Object> rs= new HashMap<String,Object>();
		rs.put("code",code);
		rs.put("msg",StringUtils.isNotEmpty(msg)?msg:SUCCESS_MSG);
		rs.put("data", data==null ? new Object() : data);
